...
function Dev:SetEnabled(on)
  ...
  _G.BreSaved.debug = _G.BreSaved.debug or {}
  _G.BreSaved.debug.devcheck = Dev._enabled
...
function Dev:Install()
  ...
  -- honor saved flag
  local sv = _G.BreSaved and _G.BreSaved.debug and _G.BreSaved.debug.devcheck
  if sv == true then
    Dev._enabled = true
  end
end
