...
function DC:MakeCheckbox(parent, textKey, x, y)
  ...
  local label = f:CreateFontString(nil, "OVERLAY", (Bre.Font and Bre.Font:Normal() or "GameFontNormal"))
...
function DC:MakeFullWidthEditBox(parent, x, y)
  ...
  -- Use Blizzard template so the box is fully interactive (mouse focus / IME / selection)
