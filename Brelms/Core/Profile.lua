...
-- - This is user-controlled and persisted in SavedVariables (BrelmsSaved.ui.profile_mode)
...
local function _EnsureSavedProfileMode()
  ...
  if type(BrelmsSaved.ui.profile_mode) ~= "string" then
    -- Default: FULL
    BrelmsSaved.ui.profile_mode = "FULL"
  end
  return BrelmsSaved.ui.profile_mode
end
